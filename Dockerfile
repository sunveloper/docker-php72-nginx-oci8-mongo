...
ADD instantclient-basic-linux.x64-21.1.0.0.0.zip /tmp/
ADD instantclient-sdk-linux.x64-21.1.0.0.0.zip /tmp/
ADD instantclient-sqlplus-linux.x64-21.1.0.0.0.zip /tmp/
